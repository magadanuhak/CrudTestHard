...
class DB
{
    ...
    {
        $this->open($_ENV['DB_HOST'], $_ENV['DB_USER'], $_ENV['DB_PASSWORD'], $_ENV['DB_NAME'], $_ENV['DB_CHARSET'], $_ENV["DB_PORT"]);
    }

    private function open($dbServer, $dbUsername, $dbPassword, $dbName, $dbEncoding, $port = "3306")
    {
        $this->connection = mysqli_connect($dbServer, $dbUsername, $dbPassword, $dbName, $port);
        if (!$this->connection) {
